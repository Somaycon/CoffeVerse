...
class Pedido(db.Model):
    ...
    cliente_id = db.Collmn(db.Integer, db.ForeignKey('tb_cliente.id'), nullable = False)
    endereco_id = db.Collmn(db.Integer, db.ForeignKey('tb_enderecos_de_entrega.id'), nullable = False)
